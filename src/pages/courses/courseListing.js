...
import {MdKeyboardArrowRight,MdOutlineKeyboardArrowLeft,GoClock,PiBookOpenText, AiOutlineEye} from '../../assets/icons/icons'
            ...
            <section className="relative table w-full py-36 lg:py-44 bg-[url('../../assets/images/course/cta.jpg')] bg-no-repeat bg-center bg-cover">
                ...
                <div className="container relative">
                    <div className="grid grid-cols-1 pb-8 text-center mt-10">
                        <h3 className="md:text-4xl text-3xl md:leading-normal leading-normal font-medium text-white">프로그램 접수</h3>
                        <h5 className="text-white/50 text-lg font-medium">현재 접수 중인 프로그램을 신청하실 수 있습니다.</h5>
                    </div>
                </div>

                <div className="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
                    <ul className="tracking-[0.5px]  mb-0 inline-flex items-center space-x-1">
                        <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out text-white/50 hover:text-white"><Link to="/index-course">하남시 장애인 체육회</Link></li>
                        <li className="inline-block text-base text-white/50 mx-0.5 ltr:rotate-0 rtl:rotate-180"><MdKeyboardArrowRight className="text-xl"/></li>
                        <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out text-white" aria-current="page">프로그램 접수</li>
                    </ul>
                </div>
            </section>
                                ...
                                return (
                                    ...
                                    <div className="group relative rounded-md shadow hover:shadow-lg dark:shadow-gray-800 duration-500 ease-in-out overflow-hidden" key={index}>
                                        <div className="relative overflow-hidden">
                                            <img src={data.image} className="group-hover:scale-110 duration-500 ease-in-out" alt="" style={{height:"250px"}}/>
                                            ...
                                            <div className="absolute start-0 bottom-0 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
                                                <div className="pb-4 ps-4 flex items-center">
                                                    <img src={data.image2} className="h-12 w-12 rounded-full shadow-md dark:shadow-gray-800 mx-auto" alt="" />
                                                    <div className="ms-3">
