...
export default function PageJobPost() {
    return (
        <div>
                            ...
                            <div className="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 rounded-md">
                                <form className="text-start">
                                    <div className="grid grid-cols-1">
                                        <h5 className="text-lg font-semibold">프로그램 등록 :</h5>
                                    </div>

                                    <div className="grid grid-cols-12 gap-4 mt-4">
                                        <div className="col-span-12 text-start">
                                            <label className="font-semibold" htmlFor="RegisterName">프로그램명 :</label>
                                            <input id="RegisterName" type="text" className="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="프로그램명" />
                                        </div>

                                        <div className="col-span-12 text-start">
                                            <label htmlFor="comments" className="font-semibold">설명 :</label>
                                            <textarea name="comments" id="comments" className="form-input mt-2 w-full py-2 px-3 h-28 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="프로그램에 대한 설명을 작성해주세요 :"></textarea>
                                        </div>

                                        <div className="md:col-span-4 col-span-12 text-start">
                                            <label className="font-semibold">종류 :</label>
                                            <select className="form-select form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0">
                                                <option value="WD">생활 체육 교실</option>
                                        ...
                                        <div className="md:col-span-4 col-span-12 text-start">
                                            <label className="font-semibold">정원 :</label>
                                            <textarea name="comments" id="comments" className="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="정원 :"></textarea>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-12 gap-4 mt-4">
                                        <div className="col-span-6 text-start">
                                            <label className="font-semibold" htmlFor="Skillname">접수 기간:</label>
                                            <input id="Skillname" type="text" className="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="예시 2024.01.01 ~ 2024.01.31" />
                                        </div>

                                        <div className="md:col-span-6 col-span-12 text-start">
                                            <label className="font-semibold" htmlFor="Qualificationname">교육 기간:</label>
                                            <input id="Qualificationname" type="text" className="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="예시 2024.02.01 ~ 2024.02.31" />
                                        </div>

                                        <div className="md:col-span-8 col-span-12 text-start">
                                            <label className="font-semibold" htmlFor="Experiencename">연락처:</label>
                                            <input id="Experiencename" type="text" className="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="연락처 : " />
                                        </div>

                                            <div className="md:col-span-4 col-span-12 text-start">
                                                <label className="font-semibold md:invisible md:block hidden">참가비 :</label>
                                                <div className="relative mt-1">
                                                    <span className="absolute top-0.5 start-0.5 w-9 h-9 text-xl bg-gray-100 dark:bg-slate-800 inline-flex justify-center items-center text-dark dark:text-white rounded">
                                                        <i className="mdi mdi-currency-usd text-indigo-600"></i>
                                                    </span>
                                                    <input type="number" className="form-input ps-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="참가비" name="minsalary" />
                                                </div>
                                            </div>
                                    ...
                                    <div className="grid grid-cols-12 gap-4 mt-4">
                                        <div className="col-span-12 text-start">
                                            <label className="font-semibold" htmlFor="Address">장소:</label>
                                            <input id="Address" type="text" className="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="장소를 입력하세요" />
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 gap-4 mt-4">
                                        <div>
                                            <button type="submit" id="submit" name="send" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center rounded-md bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white">등록 완료</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
