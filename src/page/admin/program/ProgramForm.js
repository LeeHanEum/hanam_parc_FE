                        ...
                        <div className="w-full grid md:grid-cols-12 grid-cols-1 gap-[30px] dark:bg-slate-900 shadow-md dark:shadow-gray-800 rounded-md p-8">
                            <div className="lg:col-span-6 md:col-span-6">
                                ...
                                <div className="mb-4">
                                    ...
                                    <input id="material" type="text" className="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" />
                                </div>

                                <div className="mb-4">
                                    <label className="font-semibold mr-2 block" htmlFor="manager">담당자 :</label>
                                    <Select id="manager" className="my-3" options={genderOptions} defaultValue={genderOptions[0]}/>
                                </div>
                            ...
                            <div className="lg:col-span-6 md:col-span-6 lg:mt-16">
                                <div className="mb-4 mt-3">
                                    <label className="font-semibold mr-2" htmlFor="applyEnd">접수 기한 :</label>
                                    <input id="applyEnd" type="date" className="form-input mt-3 py-2 w-full px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0"/>
                                </div>
                                ...
                                <div className="mb-4">
                                    ...
                                    <textarea id="description" style={{resize:"none"}} className="form-input mt-3 w-full py-2 px-3 h-52 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="설명을 입력하세요" />
                                </div>

                                <div className="mt-14">
                                    <Link to="/#" className="w-full py-2 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center hover:bg-green-700 border-green-600 hover:border-green-700 text-green-600 hover:text-white rounded-md me-2">프로그램 추가하기</Link>
                                </div>
                            </div>
                        </div>
                    </div>
